...
node_output_instance = NodeOutput.from_json(json)
# print the JSON string representation of the object
print(NodeOutput.to_json())

# convert the object into a dict
node_output_dict = node_output_instance.to_dict()
# create an instance of NodeOutput from a dict
node_output_from_dict = NodeOutput.from_dict(node_output_dict)
```
